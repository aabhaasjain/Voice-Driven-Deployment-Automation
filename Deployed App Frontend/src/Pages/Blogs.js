      ...
      {blogs ? blogs.length > 0 ? blogs.map(blog => {
        return (
          ...
          <CardMedia
            component="img"
            height="140"
            image={`https://travel-journal-images-test.s3.amazonaws.com/${blog.blogId}/${blog.image}`}
            alt="blog image"
     ...
     <div>
      ...
      >
        <Box sx={style}>
          ...
          <img
              src={`https://travel-journal-images-test.s3.amazonaws.com/${active.blogId}/${active.image}`}
              alt="blog"
              height = "100px"
          />
